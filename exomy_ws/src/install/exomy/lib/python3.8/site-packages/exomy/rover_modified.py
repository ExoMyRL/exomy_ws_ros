...
class Rover():
    ...
    def Set_SteeringAngles(self, lin_vel_x, ang_vel):
        ...
        if ang_vel == 0: 
            motor_speeds[self.FL] = lin_vel_x*30
            motor_speeds[self.FR] = lin_vel_x*30
            motor_speeds[self.CL] = lin_vel_x*30
            motor_speeds[self.CR] = lin_vel_x*30
            motor_speeds[self.RL] = lin_vel_x*30
            motor_speeds[self.RR] = lin_vel_x*30
